...
const Profile = () => {
	...
	return (
		<div>
			...
			<div className='flex flex-col justify-center px-12 bg-[#18191a] h-full pt-20 font-[inherit]'>
				{/* info */}
				<div className='flex lg:gap-10 max-h-[150px] mx-auto'>
					<img
				...
				{/* post of user */}
				<div className='w-8/12 mx-auto py-4 pt-20 min-h-screen'>
